...
namespace CS6613_Final
{
    ...
    public class CheckersGame : Microsoft.Xna.Framework.Game
    {
        ...
        {
            get { return cgame.Board.TileBoard.Width * TileSize; }
        }

        private int BoardHeightInPixels
        {
            get { return cgame.Board.TileBoard.Height * TileSize; }
        }
        ...
        protected override void LoadContent()
        {
            ...
            graphics.PreferredBackBufferWidth = BoardWidthInPixels + SideSize;
        ...
        protected override void Draw(GameTime gameTime)
        {
            ...
            if (cgame.SelectedPiece != null)
                finalStr += String.Format("Selected: {0}", cgame.Board.TileBoard.GetNameForLocation(cgame.SelectedPiece.X, cgame.SelectedPiece.Y));
